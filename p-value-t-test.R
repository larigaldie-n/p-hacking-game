create_dataset <- function(n_samples, n_subjects, alpha)
{
  ...
  tib <- tib %>% filter(p>alpha)
  return(tib)
}

add_subjects <- function(tib, n_add, alpha)
{
...
new_dataset <- function(tib, n_subjects, alpha)
{
...
remove_outliers <- function(tib, sdv, alpha)
{
