server <- function(input, output, session) {
  ...
  observeEvent(input$click_add_subjects_1, {
    ...
    text_log(paste0(text_log(), "You added 1 more subject per group. Type I error at this point: ", real_alpha(), "\n\n"))
  ...
  observeEvent(input$click_add_subjects_3, {
    ...
    text_log(paste0(text_log(), "You added 3 more subjects per group. Type I error at this point: ", real_alpha(), "\n\n"))
    sd_methods("All participants were included in the analysis.\n\n")
    randomize_texts()
    remove_modal_spinner()
  })
  observeEvent(input$click_add_subjects_5, {
    ...
    text_log(paste0(text_log(), "You added 5 more subjects per group. Type I error at this point: ", real_alpha(), "\n\n"))
    sd_methods("All participants were included in the analysis.\n\n")
    randomize_texts()
    remove_modal_spinner()
  })
  observeEvent(input$click_remove_outliers_2sd, {
    ...
    text_log(paste0(text_log(), "You removed participants with scores +/- 2sd. Type I error at this point: ", real_alpha(), "\n\n"))
  ...
  observeEvent(input$click_remove_outliers_25sd, {
    ...
    text_log(paste0(text_log(), "You removed participants with scores +/- 2.5sd. Type I error at this point: ", real_alpha(), "\n\n"))
  ...
  observeEvent(input$click_remove_outliers_3sd, {
    ...
    text_log(paste0(text_log(), "You removed participants with scores +/- 3sd. Type I error at this point: ", real_alpha(), "\n\n"))
  ...
  observeEvent(input$click_new_dv, {
    ...
    text_log(paste0(text_log(), "You changed the outcome variable. Type I error at this point: ", real_alpha(), "\n\n"))
    sd_methods("All participants were included in the analysis.\n\n")
    randomize_texts()
  ...
  observeEvent(input$click_new_dataset, {
    ...
    text_log(paste0(text_log(), "You recruited a whole new batch of subjects. Type I error at this point: ", real_alpha(), "\n\n"))
    sd_methods("All participants were included in the analysis.\n\n")
    randomize_texts()
    remove_modal_spinner()
  })
